// Sticker set catalog. Each set has 2 sheets (A on left, B on right of the source image).
// Pricing: $2/sheet, $3 for the pair (both sheets of one set).
const STICKER_SETS = [
  {
    id: "critters",
...
window.STICKER_SETS = STICKER_SETS;
window.PRICE_SHEET = PRICE_SHEET;
window.PRICE_PAIR = PRICE_PAIR;
